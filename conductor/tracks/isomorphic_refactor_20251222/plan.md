...
- [ ] Task: Research and select a lightweight DOM shim for Node.js (e.g., `linkedom`).
- [ ] Task: Install Node.js specific dev-dependencies (e.g., `linkedom`, `vitest` or `mocha` for unit tests).
